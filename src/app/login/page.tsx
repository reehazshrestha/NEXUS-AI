    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <Link href="/" className="flex items-center justify-center gap-2 mb-8">
          <div className="bg-gradient-to-br from-primary to-purple-500 p-2.5 rounded-xl">
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <Button
            ...
            className="w-full h-11 rounded-xl mb-6 border-border hover:bg-accent"
          >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 rounded-xl bg-gradient-to-r from-primary to-purple-600 hover:opacity-90 text-white shadow-lg shadow-primary/25 group"
            >
              {loading ? (
